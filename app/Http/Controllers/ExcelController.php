...
use App\Exports\UsersExport; // Create this export class in Step 5

class ExcelController extends Controller
{
    public function exportUsers(Request $request , $id ,$customer_id)
    {
        ...
        ->where('orderdetails.order_id', $request->id)

...
class PaymentOrderExcelMultiplesController extends Controller
{
...
// dd($array);
    ...
    $new_array = array();
        ...
        foreach($uniqueItems as $this_array){
            ...
            $new_array[$i++][] = 'Product Name :'.$this_array['name'];
            $new_array[$i++][] = 'Country Name :'.$this_array['short_country'];
            ...
            $new_array[$i++][] = 'Post Code '.$x.' :'. $ord_additions['short_post_code'];
            ...
            $new_array[$i++][] = ''.$order_role->name.' : '.$this_array['user_name'];

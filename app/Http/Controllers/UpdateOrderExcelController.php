...
class UpdateOrderExcelController extends Controller
{
    public function exportUsers(Request $request , $id )
    {
        ...
        foreach($item as $this_array){
            ...
            $new_array[0][] =  $this_array['name'];
            $new_array[1][] =  $this_array['short_country'];
          

            $new_array[2][] =   $this_array['comfirmation'];
            $new_array[3][] =  $this_array['status_payment'];
            $new_array[4][] =  $this_array['commision'];
            $new_array[5][] =  $this_array['reason'];
            $new_array[6][] =  $this_array['short_delivery_date'];

            $new_array[7][] =  $this_array['short_post_code'];
          
            // $new_array[6][] = 'Created At :'.$this_array['user_create_date'];
            // $new_array[5][] = 'Email :'.$this_array['email'];
            $new_array[8][] = $this_array['user_name'];
        }
 $columns = [

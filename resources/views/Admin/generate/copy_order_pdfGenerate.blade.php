...
<body>
    ...
    <?php 
  $CopyShortOrder = App\Models\CopyShortOrder::where('id', $order->short_orders_id)->first();
    ...
    <table class="order-details">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><Canvas>Comfirmation</Canvas> :</td>
                <td> {{ $order->comfirmation ?? 'Empty' }}</td>
            </tr>
            <tr>
                <td>Status :</td>
                <td>{{ $order->status ?? 'Empty' }}</td>
    
                <td><Canvas>Commission</Canvas> :</td>
                <td> {{ $order->commision ?? 'Empty' }}</td>
            </tr>
            <tr>
                <td>Reason :</td>
                <td>{{ $order->reason ?? 'Empty' }}</td>
                <td>Created By:</td>

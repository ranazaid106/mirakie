...
<div class="col-lg-12">
    ...
    @if(session('success'))
        ...
        @endif
        <div class="card-header">Update Data Details</div>
        <div class="card-body">
            <hr>
            <form action="{{ url('link_update', $item->id) }}" method="post" class="form-horizontal">
                @csrf
                @method('PUT')
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <textarea id="editor" name="link" class="form-control" rows="3" data-val="true" selected>{{$item->links}}</textarea>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <textarea id="note_editor" name="note" class="form-control" rows="3" data-val="true" selected>{{$item->note}}</textarea>
                ...
                <div>
                    <center>
                        <div class="card-footer" style="margin-top: 50px;">
                            ...
                            <a type="reset" class="btn btn-danger btn-sm" style="margin-left: 20px;" href="{{route('details')}}">

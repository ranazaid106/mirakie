...
<div class="row">
    <div class="col-md-12">
        <!-- DATA TABLE -->
        <h3 class="title-5 m-b-35">Data Details</h3>
        @if(session('success'))
        ...
        <div class="table-data__tool">
            ...
            <div class="table-data__tool-right">
                <a class="au-btn au-btn-icon au-btn--green au-btn--small" style="color:white" href="{{route('createDetails')}}">
                    <i class="zmdi zmdi-plus"></i>add Data Details</a>
            </div>
            <?php
                }else {
            ...
            <table class="table table-data2">
                ...
                <tbody>
                    ...
                    <tr class="tr-shadow">
                        ...
                        <td>
                        <a href="{{ $item->note }}" target="_blank">{!! $item->note !!}</a>
                        </td>
                        ...
                        <td>
                            <div class="table-data-feature">
                                ...
                                if ($users->status == '2') {
                                 ?>
                                 <a class="item" data-toggle="tooltip" style="right:75%" data-placement="top" title="Edit" href="{{route('link_edit',$item->id)}}">
                                    <i class="zmdi zmdi-edit"></i>
                                </a>

                                 <a class="item" data-toggle="tooltip" style="right:75%" data-placement="top" title="Delete" href="{{route('destroylink',$item->id)}}">

...
<div class="col-lg-12">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <hr>
            <form action="{{route('storerole')}}" method="post" class="form-horizontal">
                @csrf
                ...
                <div style="margin-left:58px;">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            @if(strpos($item->name, "User") != false)
                            <label class="container">{{$item->name}}
                                <input class="item-checkbox" type="checkbox" value="{{$item->id}}" name="permissions[]" />
                                <span class="checkmark"></span>
                            </label>
                            @endif
                            @endforeach
                        ...
                        <div class="col-md-4">
                            ...
                            <hr>
                            @foreach($items as $item)
                            @if(strpos($item->name, "Role") != false)
                            <label class="container">{{$item->name}}
                                <input class="item-checkbox" type="checkbox" value="{{$item->id}}" name="permissions[]" />
                                <span class="checkmark"></span>
                            </label>
                        ...
                        <div class="col-md-4">
                            ...
                            <hr style="margin-right:40px">
                            @foreach($items as $item)
                            @if(strpos($item->name, "Order") != false)
                            <label class="container">{{$item->name}}
                                <input class="item-checkbox" type="checkbox" value="{{$item->id}}" name="permissions[]" />
                                <span class="checkmark"></span>
                            </label>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <hr>
                            @foreach($items as $item)
                            @if((strpos($item->name, "Product ") == false) && (strpos($item->name, "Product") != false) )
                            <label class="container">{{$item->name}}
                                <input class="item-checkbox" type="checkbox" value="{{$item->id}}" name="permissions[]" />
                                <span class="checkmark"></span>
                            </label>
                        ...
                        <div class="col-md-4">
                            ...
                            <hr>
                            @foreach($items as $item)
                            @if(strpos($item->name, "Product Variation") != false)
                            <label class="container">{{$item->name}}
                                <input class="item-checkbox" type="checkbox" value="{{$item->id}}" name="permissions[]" />
                                <span class="checkmark"></span>
                            </label>
                        ...
                        <div class="col-md-4">
                            ...
                            <hr style="margin-right:40px">
                            @foreach($items as $item)
                            @if(strpos($item->name, "Customer") != false)
                            <label class="container">{{$item->name}}
                                <input class="item-checkbox" type="checkbox" value="{{$item->id}}" name="permissions[]" />
                                <span class="checkmark"></span>
                            </label>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <hr>
                            @foreach($items as $item)
                            @if(strpos($item->name, "Coupen") != false)
                            <label class="container">{{$item->name}}
                                <input class="item-checkbox" type="checkbox" value="{{$item->id}}" name="permissions[]" />
                                <span class="checkmark"></span>
                            </label>
                        ...
                        <div class="col-md-4">
                            ...
                            <hr>
                            @foreach($items as $item)
                            @if(strpos($item->name, "File Upload") != false)
                            <label class="container">{{$item->name}}
                                <input class="item-checkbox" type="checkbox" value="{{$item->id}}" name="permissions[]" />
                                <span class="checkmark"></span>
                            </label>

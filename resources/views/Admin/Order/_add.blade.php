                                    ...
                                    <div class="third_button" style="display: none;" >
                                        ...
                                        <hr>                             
                                           ...
                                           {{--  Three Button show end  --}}
                                               ...
                                               {{-- With Diamond form show start  luxury  --}}
                                        ...
                                        <option value="Split-Panel" style="color:#686B6D">Split-Panel</option>
                                        <option value="Split-Panel" style="color:#686B6D">Split-Panel</option>
                                        <option value="Panel wing back" style="color:#686B6D">Panel wing back </option>
                                        <option value="Split-Florida Diamond" style="color:#686B6D">Split-Florida Diamond </option>
                                        <option value="Split-Florida Button" style="color:#686B6D">Split-Florida Button</option>
                                        <option value="Floor Standing-Florida Diamond" style="color:#686B6D">Floor Standing-Florida Diamond </option>
                                        <option value="Floor Standing-Florida Button" style="color:#686B6D">Floor Standing-Florida Button </option>
                                        ...
                                        <option value="Mini Arizona" style="color:#686B6D">Mini Arizona</option>
                                                    ...
                                                    <select class="form-control With_Fabric_empty_value" name="with_diamond_fabric" style="color:#686B6D" id="designField"  >
                                                        ...
                                                        <option value="Leather" style="color:#686B6D">Leather</option>
                                                        <option value="Suede" style="color:#686B6D">Suede </option>
                                                        <option value="Softt mat" style="color:#686B6D">Softt mat </option>
                                                    ...
                                                    <select class="form-control With_Mattress_empty_value" name="with_diamond_mattress" style="color:#686B6D" id="designField"  >
                                                        <option value="" style="color:#686B6D">select Mattress  </option>
                                                        <option value="No Mattress" style="color:#686B6D">No Mattress</option>
                                                        <option value="simple - Semi ortho 8 inch" style="color:#686B6D">simple-Semi ortho 8 inch</option>
                                                        <option value="Orthopadic sprung 10 inch" style="color:#686B6D">Orthopadic sprung  10 inch</option>
                                                        <option value="Orthopadic Memory foam 10 inch" style="color:#686B6D">Orthopadic Memory foam  10 inch</option>
                                                        <option value="Memory foam 10 inch" style="color:#686B6D">Memory foam 10 inch</option>
...
<div class="row" >
    <div class="col-md-6 m-2 select_delivery_status" style="display: none">
        <a class="btn btn-primary select_delivery_status" style="color: white" >Select Delivery status</a>
       
    </div>
    <div class="col-md-6 m-2">
        <a class="btn btn-primary custom_btn_delivery custom_deliver_enter"  style="color: white" >Custom Delivery status</a>
                                    ...
                                    <div id="textSelectdiv" class="deliver_div_status">
                                            <select  id="orderdelivery" name="sect_delivery_status"  class="select form-control delivery_stattus_values_" style="display: inline;color:#686B6D">
                                      ...
                                      <div id="custom_deliivery_status_item" class="form-outline custom_deliivery_status_item" style="display: none">
                                        <input type="text" id="form12" name="delivery_status" class="form-control custom_status_values_"  placeholder="Enter your custom option here"  />
                                      </div>
                                      <br>
...
<script>
     ...
     $(document).ready(function(){
      ...
      $(".custom_deliver_enter").click(function(){

        $(".custom_deliivery_status_item").show();
    $(".select_delivery_status").show();  
    $(".custom_btn_delivery").hide();
    $(".deliver_div_status").hide();
    $(".delivery_stattus_values_").val("");

      });

      $(".select_delivery_status").click(function(){

        $(".custom_deliivery_status_item").hide();
    $(".select_delivery_status").hide();  
    $(".custom_btn_delivery").show();
    $(".deliver_div_status").show();
    $(".custom_status_values_").val("");
...
$(document).ready(function(){
    ...
    $('.country_code_select').on('change', function() { 
        ...
        var count_code = $(".country_code_select").val();

        // alert(count_code);
        if(count_code == 'UK'){
            var exect_code =  'gb';
        }else if(count_code == 'Pakistan'){
            var exect_code =  'pk';
        }else if(count_code == 'United states of america'){
            var exect_code =  'uy';
        }else if(count_code == 'Australia'){
            var exect_code =  'au';
        }else if(count_code == 'Canada'){
            var exect_code =  'ca';
        }else if(count_code == 'Germany'){
            var exect_code =  'de';
        }else if(count_code == 'France'){
            var exect_code =  'fr';
        }else if(count_code == 'China'){
            var exect_code =  'cn';
        }else if(count_code == 'India'){
            var exect_code =  'in';
        }else{
            var exect_code =  'gb';
        }
        ...
        window.intlTelInput(input, {
            ...
            preferredCountries: [ exect_code ]

            // preferredCountries: [ "gb","pk", "ru", "jp", "no"]
        });
...
var  Headboard_size_empty_values =  $(".Headboard_size_empty_value").val();
var  Headboard_design_empty_values = $(".Headboard_design_empty_value").val();
var  Headboard_color_empty_values = $(".Headboard_color_empty_value").val();
var  Headboard_Fabric_empty_values = $(".Headboard_Fabric_empty_value").val();

        if(Headboard_size_empty_values != ""  && Headboard_design_empty_values != ""  && Headboard_color_empty_values != ""  && Headboard_Fabric_empty_values != "" ){

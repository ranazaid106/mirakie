                                ...
                                <div class="form-card">
                                    ...
                                    <div class="row" >
                                        <div class="col-md-6 m-2 select_delivery_status" style="display: none">
                                            ...
                                            {{-- <button class="btn btn-primary"  onclick="select_delivery_status()">Select Delivery status</button> --}}
                                        </div>
                                        <div class="col-md-6 m-2">
                                         <a class="btn btn-primary custom_btn_delivery custom_deliver_enter"  style="color: white" >Custom Delivery status</a>
                                            {{-- <button class="btn btn-primary custom_btn_delivery" onclick="custom_deliver_enter()" >Custom Delivery status</button> --}}
                                        </div>
                                    ...
                                    <div id="textSelectdiv" class="deliver_div_status">
                                        <select  id="orderpayment" name="sect_delivery_status"  class="select form-control" style="display: inline;color:#686B6D">
                                      ...
                                      <div id="inputDiv" class="form-outline disaplayInput custom_deliivery_status_item" style="display: none">

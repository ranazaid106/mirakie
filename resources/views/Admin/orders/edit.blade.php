                ...
                <div class="row">
                    <div class="col-md-12 mx-0">
                        <form id="msform" class="reset_form_click" method="post" onsubmit="submit_universal_form('msform');" >
                            ...
                            <input type="hidden" name="hide_val" value="{{ $item->id }}" >
                            <fieldset class="first_order_item">
                                <div class="form-card" id="original-div">
                                    ...
                                    <select class="form-control changecountry country_code_select" name="country" style="color:#686B6D" id="topField" onchange="enableFields(this.value)" required>
                                        ...
                                        <option value="{{$country}}" {{$item->short_country == $country ? 'selected': '' }} style="color:#686B6D">{{$country}}</option>
                                        @endforeach
                                    </select></br>
                                  ...
                                  <div class="cover_products"  >  
                                    ...
                                    <select class="form-control changeproduct" name="product" style="color:#686B6D" id="productField" onchange="enableVariations(this.value)"  required>
                                        ...
                                        @if(!empty($item->short_product))
                                        <option selected value="{{$item->short_product}}" style="color:#686B6D">{{$item->name}}</option>
                                    @endif
                                    </select></br>
                                   </div>
                                   <!-- {{-- form --}} -->
                                   <div class="show_button" >
                                    <div class="mattrees_size">
                                        ...
                                        <textarea rows="15" cols="50" placeholder="Please Put Your Order Here" name="message_order" class="message_order_1" >{{ $item->short_order_message ?? '' }}</textarea>
                                        ...
                                        <input types="text" value="{{ $item->short_post_code ?? '' }}" name="post_codde" id="orderpostcode" class="post_code_1">
                                       </br>
                                        </div>  
                                        <div class="mattrees_color"> 
                                            ...
                                            <input type="date" value="{{ $item->short_delivery_date ?? '' }}" name="delivery_date" class="delivery_date_1">
                                           </br>
                                            </div>                  
                                   </div>
                                   <!-- {{-- form --}} -->
